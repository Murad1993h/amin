...
import 'bottom_navbar/appointments.dart';
import 'bottom_navbar/check_up.dart';
import 'bottom_navbar/home.dart';
import 'bottom_navbar/profile.dart';
import 'bottom_navbar/search.dart';
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        current_tab == 1
            ? Navigator.push(
                context, MaterialPageRoute(builder: (_) => doctor_mainHome()))
            : current_tab == 2
